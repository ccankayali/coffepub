            ...
            <div className='container'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div data-aos='zoom in'>
                        <Image src='/images/2.png' alt='' width={420} height={420} className='spinOne mx-auto' />
                    </div>
                    <div className='flex flex-col justify-center gap-6'>
                        <h1 className='text-3xl md:text-4xl font-bold font-second2' data-aos='fade-up'>Premium Coffee</h1>
